...
__all__ = ['get_video_list', 'download_video', 'download_all_videos', 'download_youtube_video', 'text_to_speech',
           'get_credits', 'crop_video', 'crop_audio', 'get_resolution', 'get_fps']
...
# Cell
def text_to_speech(text, speaker, outfile):
...
# Cell
def crop_audio(audio, start, end, outfile = None):
    """
